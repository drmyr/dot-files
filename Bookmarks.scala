object Bookmarks {
	val reactive = Map(4 -> "https://www.youtube.com/watch?v=jOvpuVwj8po&index=3&list=PLMhMDErmC1TdBMxd3KnRfYiBV2ELvLyxN",
  ...
  val certs = Map(1 -> "http://nategood.com/client-side-certificate-authentication-in-ngi")
